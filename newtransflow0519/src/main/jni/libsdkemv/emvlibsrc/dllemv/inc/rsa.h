...
((unsigned
         char *, unsigned int, NN_DIGIT *, unsigned int));

void NN_Assign PROTO_LIST ((NN_DIGIT * , NN_DIGIT *, unsigned
                                   int));

void NN_AssignZero PROTO_LIST ((NN_DIGIT * , unsigned
                                       int));

void NN_Assign2Exp PROTO_LIST ((NN_DIGIT * , unsigned
                                       int, unsigned
                                       int));

NN_DIGIT NN_Add PROTO_LIST
((NN_DIGIT * , NN_DIGIT *, NN_DIGIT *, unsigned
         int));
...
void NN_Mult PROTO_LIST ((NN_DIGIT * , NN_DIGIT *, NN_DIGIT *, unsigned
                                 int));
...
((NN_DIGIT * , NN_DIGIT *, unsigned
         int, NN_DIGIT *, unsigned
         int));

void NN_ModMult PROTO_LIST
((NN_DIGIT * , NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned
         int));
...
void NN_Gcd PROTO_LIST ((NN_DIGIT * , NN_DIGIT *, NN_DIGIT *, unsigned
                                int));

int NN_Cmp PROTO_LIST ((NN_DIGIT * , NN_DIGIT *, unsigned
                               int));

int NN_Zero PROTO_LIST ((NN_DIGIT * , unsigned
                                int));

unsigned int NN_Bits PROTO_LIST ((NN_DIGIT * , unsigned
                                         int));

unsigned int NN_Digits PROTO_LIST ((NN_DIGIT * , unsigned
                                           int));
...
void NN_LShiftBits(NN_DIGIT *a, NN_DIGIT *b, unsigned int c, unsigned int bDigits);
...
unsigned int s_uint4_toinvert_char(UINT4 *buf4, unsigned int buf4Len, unsigned char *buf);

#define ByteOrder    1
#define MAX_NN_LEN 62
#define LOW_AHEAD    0
#define HIGH_AHEAD   1
