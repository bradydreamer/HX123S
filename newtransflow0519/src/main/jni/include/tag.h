...
#undef S32
/*=======BEGIN: wangbin 2016.03.01  modify===========*/
//华夏银行--begin
#define    TAG_TRADEID_Locate           "trade_id_locate"
#define    TAG_TRADEID_DownLoadPMK      "trade_id_downloadPrimaryKey"
//华夏银行--end
#define TAG_TRADEID_SIGNIN				"trade_id_signin"            //签到
#define TAG_TRADEID_SALE		        "trade_id_sale"              //消费
#define TAG_TRADEID_UNSALE				"trade_id_unsale"            //撤销

#define TAG_TRADEID_REFUND               "trade_id_refund"           //退货
#define TAG_TRADEID_PREAUTH              "trade_id_preauth"          //预授权
#define TAG_TRADEID_UNPREAUTH            "trade_id_unpreauth"        //预授权撤销
#define TAG_TRADEID_ADDPREAUTH           "trade_id_addpreauth"


#define TAG_TRADEID_COMPLETE              "trade_id_complete"         //预授权完成
#define TAG_TRADEID_UNCOMPLETE            "trade_id_uncomplete"       //预授权完成撤销

#define TAG_TRADEID_OFFCOMPLETE           "trade_id_Offcomplete"
/*=======BEGIN: wangbin 2016.05.10  modify===========*/
#define TAG_TRADEID_ECOFFSALE              "trade_id_ec"                       //电子现金
#define TAG_TRADEID_ECOFFUP                "trade_id_offlineupload"            //电子现金上送

#define TAG_TRADEID_ECCASH                 "trade_id_eccash"                   //电子现金充值
#define TAG_TRADEID_ECCACC                 "trade_id_eccacc"                   //电子指定账户充值
/*====================== END======================== */
/*=======BEGIN: wangbin 2016.05.11  modify===========*/
#define TAG_TRADEID_ECCACCNO                "trade_id_eccaccno"                 //电子现金非指定账户圈存
#define TAG_TRADEID_QPBOC                   "trade_id_qpboc"                    //QPBOC
#define TAG_TRADEID_UNECCASH                "trade_id_uneccash"                 //电子现金充值撤销

#define TAG_TRADEID_POINTSALE_ISSUER        "trade_id_pointbanksale"            //发卡行积分消费
#define TAG_TRADEID_POINTSALE_UNION         "trade_id_pointunionsale"           //联盟积分消费

#define TAG_TRADEID_POINTUNSALE_ISSUER       "trade_id_pointbankvoid"           //发卡行积分消费撤销
#define TAG_TRADEID_POINTUNSALE_UNION        "trade_id_pointuionvoid"           //联盟积分消费撤销

#define TAG_TRADEID_POINTQUERY_UNION         "trade_id_pointuionquery"          //联盟积分查询
#define TAG_TRADEID_POINTREFUND_UNION        "trade_id_pointuionrefund"          //联盟积分退货

#define TAG_TRADEID_INSTALLMENTSALE          "trade_id_installment"              //分期消费
#define TAG_TRADEID_INSTALLMENTUNSALE        "trade_id_uninstallment"            //分期付款撤销

#define TAG_TRADEID_OFFSETTLE                "trade_id_offsettle"                //离线结算交易
#define TAG_TRADEID_ADJUST                   "trade_id_adjust"                   //调整
/*====================== END======================== */
/*=======BEGIN: huacong 2016.03.11  11:9 modify===========*/
#define TAG_TRADEID_QUERY                    "trade_id_query"                     //查余
#define TAG_TRADEID_SETTLE                   "trade_id_settle"                    //结算
/*====================== END======================== */
...
//华夏银行--end
#define TAG_MerchantName	                      "FF8018"                //商户名称
#define TAG_IS_PRINT_DETAIL	                      "FF8071"                //

#define TAG_TRADE_TYPE					          "FF9000"
#define TAG_8583_CARDNO                           "FF9001"                 //卡号
#define TAG_8583_AMOUNT                           "FF9002"                 //交易金额
#define TAG_8583_VoucherNo                        "FF9003"                 //流水号
#define TAG_8583_HMS                              "FF9004"                //受卡方所在地时间
#define TAG_8583_MD                               "FF9005"                //受卡方所在地日期

#define TAG_8583_POSVLU                           "FF9014"                //收单机构信息

#define TAG_8583_ExpiredDate                       "FF9006"              //卡有效期
#define TAG_8583_CardMode                          "FF9008"              //用卡方式
#define TAG_8583_CardParam                         "FF9009"              //
#define TAG_8583_BKRESULT                          "FF9010"              //应答码
#define TAG_SYS_CardID                             "FF900A"              //卡序列号
#define TAG_8583_Track2Data                        "FF900D"              //二磁信息
#define TAG_8583_Track3Data                        "FF900E"              //三磁信息
#define TAG_8583_SysRefNo                          "FF900F"              //检索参考号
#define TAG_8583_AuthCode                          "FF901F"              //授权码
#define TAG_8583_MerchantNo                        "FF9011"              //终端编号
#define TAG_8583_TerminalNo                        "FF9012"              //商户编号

#define TAG_8583_IssuerBank                        "FF9013"              //发卡机构信息
#define TAG_8583_AcquirerBank                      "FF9014"              //收单机构信息


#define TAG_8583_CurrencyCode                      "FF901B"              //交易货币代码
#define TAG_8583_CreditPwd                         "FF901C"              //个人标识码

#define TAG_8583_DomainExist                       "FF901D"              //
#define TAG_8583_EMV55Type                         "FF902D"              //IC卡数据域、手机芯片专用子域

#define TAG_8583_BALANCETYPE                       "FF9020"              //余额符号
#define TAG_8583_BALANCE                           "FF9021"              //余额

#define   TAG_8583_OLDVOUCHERNO                    "FF9029"              //原交易流水号

#define    TAG_8583_AsBatchNo                      "FF9022"              //批次号
#define    TAG_8583_SignSupport                    "FF9026"              //支持部分扣款和返回余额的标志
#define    TAG_8583_OldAsBatchNo                   "FF9028"              //原交易批次号
#define    TAG_8583_OldVoucherNo                   "FF9029"              //原交易流水号
#define    TAG_8583_AsTradeDate                    "FF902A"              //原交易日期
...
#define    TAG_8583_OldSysRefNo                     "FF9054"              //原交易终端号
#define    TAG_8583_UsManNo                         "FF9041"              //操作员代码
#define    TAG_8583_MAC                             "FF9045"              //MAC

#define    TAG_8583_FieldALL                        "FF9030"

/*=======BEGIN: huacong 2016.03.03  15:47 modify===========*/
#define    TAG_TRADE_MACTYPE                        "FF8010"               //MAC算法标志

#define    TAG_TRADE_SUPPORTTDK                      "FF8015"              //磁道信息加密标志
#define    TAG_TRADE_TMKINDEX                        "FF8016"              //终端密钥索引
#define    TAG_TRADE_DESTYPE                         "FF8017"              //加密算法标志
//华夏银行--begin
...
#define TAG_TRADE_REVERSAL                          "FF907E"               //冲正标签
#define TAG_TRADE_REVERSALBAG                       "FF907F"               //冲正报文

#define TAG_TRADE_UNDOFLAG                          "FF907B"               //撤销标志
#define TAG_TRADE_TRCARDNO                          "FF908B"               //转入卡卡号

#define TAG_SCIRTP_SCRIPT                            "FF9072"              //发卡行脚本结果
#define TAG_SCIRTP_SENDFLAG                          "FF9073"              //执行脚本通知交易的原始发送报文
#define TAG_SCIRTP_RCVEFLAG                          "FF9074"              //执行脚本通知交易的原始接收报文

/*=======BEGIN: huacong 2016.03.17  17:11 modify===========*/
#define TAG_TRADE_DEBITCREDIT                       "FF9075"               //借贷记标志
#define TAG_TRADE_CARDINOUT                         "FF9076"               //内外卡标志
#define TAG_TRADE_TIME                              "FF9079"               //重发次数
...
#define TAG_TRADE_EQRECV                            "FF9080"               //离线交易结果  接收或者拒绝

#define TAG_TRADE_ASPERIOD                          "FF9081"               //分期期数
#define TAG_TRADE_ITEMCODE                          "FF9082"               //商品编码
#define TAG_TRADE_PAYMODE                           "FF9083"               //分期手续费支付方式

#define TAG_TRADE_INSPAY                            "FF9084"               //分期首付款
#define TAG_TRADE_CardHOLDERFEE                     "FF9085"               //持卡人手续费
#define TAG_TRADE_REPAYMENT                         "FF9087"               //分期还款币种
#define TAG_TRADE_EXPROSCORE                        "FF9088"               //兑换积分数
#define TAG_TRADE_EXPROQUERY                        "FF9089"               //积分余额数
#define  TAG_TRADE_SELFAMOUNT                       "FF908A"               //自付金额
#define  TAG_TRADE_UPADD                            "FF906E"               //批上送断点
#define  TAG_TRADE_TOTALUPNUM                       "FF906F"               //批上送总数
#define  TAG_TRADE_UPMODE                           "FF906D"               //批上送模式
