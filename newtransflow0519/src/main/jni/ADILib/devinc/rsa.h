...
//#include "global.h"  //SXL arm_linux
/*=======BEGIN: ���ٲ� 2013.07.17  9:23 modify===========*/
//#include "../../math/rsaglobal.h"  //SXL arm_linux//sjz??? 2013.01.06 8:57
#include "rsaglobal.h"  //SXL arm_linux//sjz??? 2013.01.06 8:57
/*====================== END======================== */
...
PROTO_LIST
((NN_DIGIT
*, NN_DIGIT *, NN_DIGIT *, unsigned int, NN_DIGIT *,
unsigned int));
NN_DIGIT NN_LShift
PROTO_LIST
((NN_DIGIT
*, NN_DIGIT *, unsigned int, unsigned int));
NN_DIGIT NN_RShift
PROTO_LIST
((NN_DIGIT
*, NN_DIGIT *, unsigned int, unsigned int));
