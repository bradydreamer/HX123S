...
//	};
	...
	protected EmvAidPara(Parcel in) {
		this.AID = in.createByteArray();
		this.AID_Length = in.readInt();
		this.AppSelIndicator = in.readByte();
		this.TerminalPriority = in.readByte();
		this.MaxTargetDomestic = in.readByte();
		this.TargetPercentageDomestic = in.readByte();
		this.TFL_Domestic = in.createByteArray();
		this.ThresholdValueDomestic = in.createByteArray();
		this.MaxTargetPercentageInt = in.readByte();
		this.TargetPercentageInt = in.readByte();
		this.TFL_International = in.createByteArray();
		this.ThresholdValueInt = in.createByteArray();
		this.TermAppVer = in.createByteArray();
		this.MerCateCode = in.createByteArray();
		this.TransCateCode = in.readByte();
		this.TrnCurrencyCode = in.createByteArray();
		this.TermCountryCode = in.createByteArray();
		this.TAC_Default = in.createByteArray();
		this.TAC_Denial = in.createByteArray();
		this.TAC_Online = in.createByteArray();
		this.DDOL = in.createByteArray();
		this.DDOL_Length = in.readByte();
		this.TDOL = in.createByteArray();
		this.TDOL_Length = in.readInt();
		this.TrnCurrencyExp = in.readByte();
		this.EC_TFL = in.createByteArray();
		this.TermType = in.readByte();
		this.TermCap = in.createByteArray();
		this.AddTermCap = in.createByteArray();
		this.RFOfflineLimit = in.createByteArray();
		this.RFTransLimit = in.createByteArray();
		this.RFCVMLimit = in.createByteArray();
		this.TransProp = in.createByteArray();
		this.StatusCheck = in.readByte();
		this.AcquirerID = in.createByteArray();
	}

	public static final Creator<EmvAidPara> CREATOR = new Creator<EmvAidPara>() {
		public EmvAidPara createFromParcel(Parcel source) {
			return new EmvAidPara(source);
		}
